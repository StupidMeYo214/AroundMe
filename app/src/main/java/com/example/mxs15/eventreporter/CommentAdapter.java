...
public class CommentAdapter extends RecyclerView.Adapter {
    ...
    private void configureCommentView(final CommentViewHolder holder, int position) {
        position -= 1;
        holder.commentUser.setText(commentList.get(position).getCommenter());
        holder.commentTime.setText(Utils.timeTransformer(commentList.get(position).getTime()));
        holder.commentDescription.setText(commentList.get(position).getDescription());
